  ...
  if (typeof size === 'number') {
    return (
      <UIIcon
        ...
        ref={ref as React.Ref<React.ComponentRef<typeof UIIcon>>}
        {...props}
...
const accessClassName = (style: StyleObject | StyleObject[]) => {
  ...
  >(function UIIcon({ className, ...inComingprops }, ref) {
    const calculateClassName = React.useMemo(() => {
      return className === undefined
        ? String(accessClassName(inComingprops?.style) || '')
        : className;
...
const SettingsIcon = createIcon({
  ...
  path: (
    <>
      ...
      />
      <path
        d='M18.87 2C18.87 2.5304 18.37 3 17.78 3H6.22C5.63 3 5.13 2.5304 5.13 2V2H18.87V2Z'
        strokeWidth='2'
        strokeLinecap='round'
        strokeLinejoin='round'
      />
      <path
        d='M18.87 22C18.87 21.4696 18.37 20.9999 17.78 20.9999H6.22C5.63 20.9999 5.13 21.4696 5.13 22V22H18.87V22Z'
        strokeWidth='2'
        strokeLinecap='round'
        strokeLinejoin='round'
      />
...
const TrashIcon = createIcon({
  ...
  path: (
    <>
      ...
      <path
        d='M19 6V20C19 21.1046 18 22 17 22H7C6 22 5 21.1046 5 20V6'
        strokeWidth='2'
        strokeLinecap='round'
        strokeLinejoin='round'
      />
